...
**Practical Result**
  ...
  This week, we settle down to correct raw satelliteimagery with Dark Object Subtraction (DOS)
...
![PCA_band4_character](output/correction/output/PCA_band4.png){width=100%}
![SHV_DN](output/correction/output/SHV_DN.png){width=100%}
![texture plot](output/correction/output/texture.png){width=100%}
